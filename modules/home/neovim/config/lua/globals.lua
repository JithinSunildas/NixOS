_G.tools = {
    ui = {
        -- KEEP THESE: Your statusline needs them for Git and Diagnostics
        icons = {
            branch      = "",
            bullet      = "•",
            lock        = "",
...
-- DELETED: The loop that added spaces to kind_icons

-- files and directories -----------------------------
local branch_cache = setmetatable({}, { __mode = "k" })
local remote_cache = setmetatable({}, { __mode = "k" })

-- ... (Rest of your Git functions remain exactly the same) ...
